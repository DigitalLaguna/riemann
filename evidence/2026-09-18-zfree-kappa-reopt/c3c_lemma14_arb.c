...
int main(void) {
    ...
    arb_set_str(th, "1.1338", PREC);
    arb_set_str(eta0, "0.0071093", PREC);
    arb_set_str(sigma0, "0.9935164", PREC);
    arb_set_si(tmp, 865534);
    arb_set_si(tmp2, 497079);
    arb_div(a1, tmp, tmp2, PREC);
    arb_set_si(a0, 1);
